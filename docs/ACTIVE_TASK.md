...
| 2026-09-23 | Orbit 2.5 built on `2.5/values-in-your-words`, **held for review, not merged** (Decision 20, 0032): a phrase of a sentence names the value it means, and the author's word binds the table's column, the walk's read and the compiled comparison. See `docs/TODO.md` for what main lacks without it. |
