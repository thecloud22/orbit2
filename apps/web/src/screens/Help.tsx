...
const TOPICS: Array<{ topic: string; answers: Array<{ q: string; a: string }> }> = [
  ...
  { topic: 'Writing a procedure', answers: [
    ...
    { q: 'Can I start without a document?',
      a: 'Yes. Tick "Start from a blank page" when you bring a procedure in, and write it on the agent\'s page. Every sentence is sorted as it arrives, and nothing is drafted until you confirm.' },
