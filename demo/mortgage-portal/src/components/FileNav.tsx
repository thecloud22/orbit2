type FileTab = 'underwriting' | 'documents' | 'automated-underwriting' | 'pricing';
...
const TABS: readonly { tab: FileTab; label: string; path: string; testId: string }[] = [
  ...
  },
  {
    ...
    path: '/underwriting/automated-underwriting',
    testId: 'file-nav-automated-underwriting',
  },
 ...
 * workspaces. Without this, documents/automated-underwriting/pricing are only reachable by
